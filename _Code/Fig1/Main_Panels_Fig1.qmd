...
Using both manual curation and UCSC 100-way multiple genomes alignment data [@Miller2007], I extracted the genomic coordinates of SUZ12 exon 4 in 153 vertebrates species. I total I extract 159 as some species (zebrafish, guppy, lyretail-cichlid, turquoise-killifish, medaka) have an extra round of whole genome duplication and there are 2 copies of SUZ12 for which it's hard to decide which is the [ohnolog gene](https://en.wikipedia.org/wiki/Sequence_homology#Ohnology). SUZ12 exon 4 is 69 base pairs in all species and with the same intronic/exonic phase.
...
Make also individual pim heatmaps of each region with different minimum percentage value.
...
Sequence logos are graphical presentation of patterns in aligned sequences [@Schneider1990], reviewed in [@Wasserman2004]. The specificity of each letter (i.e. nucleotide) at each position of the alignment is measured in bits which is a unit of information content.
:::
